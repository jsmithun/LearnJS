...
var Parser = function(data){
	...
	var getBrand = function(passingData){
		...
		if(typeof passingData != "undefined" && typeof passingData.brand != "undefined" && passingData.brand != null){
			...
			|| $(data, "body").find("#mocaBBSoldByAndShipsFrom a").text() || $(data, "body").find("#byline a:first").text() || $(data, "body").find("#bylineInfo").text() || 
			$(data, "body").find("#bylineInfo_feature_div").text();
		}
	...
	var getPrice = function(passingData){
      	...
      	$(data, "body").find("#olp_feature_div a:first").text();
